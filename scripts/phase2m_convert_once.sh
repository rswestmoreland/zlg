...
workdir="${TMPDIR:-/tmp}/zlg_phase2m_convert.$$"
...
results_csv="validation_results/phase2m_convert.csv"
results_md="validation_results/phase2m_convert.md"
mkdir -p validation_results
printf 'format,helper,status,detail\n' > "$results_csv"
{
  echo '# Phase 2m convert smoke'
  echo
...
echo "phase2m convert smoke passed"
